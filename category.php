...
<head>
    ...
    <title><?= htmlspecialchars($current_category['name']) ?> – BookVerse 3D</title>
...
<body>
    ...
    <div class="glass-navbar-wrapper">
        <nav class="navbar navbar-expand-lg glass-navbar">
            <div class="container-fluid px-0">
                ...
                <button class="navbar-toggler border-0 text-white shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCat">
    ...
    <header class="hero-section container">
        ...
        <div class="hero-badge">
            <i class="fas fa-folder-open text-info"></i> Category Showcase
        </div>
        <h1 class="hero-title">
            <span class="text-gradient"><?= htmlspecialchars($current_category['name']) ?></span> Collection
        </h1>
        <p class="hero-subtitle">
            Curated selection of titles and literature in the <?= htmlspecialchars($current_category['name']) ?> genre.
        </p>
    </header>
    ...
    <main class="books-container">
        <div class="section-header-row">
            <h2 class="section-title-3d">
                <i class="fas fa-layer-group text-gradient"></i> Available Books
            </h2>
            <div class="text-secondary small">
                <?= is_array($books) ? count($books) : 0 ?> titles found
            </div>
        </div>
        ...
        <?php if (empty($books)): ?>
            <div class="glass-panel p-5 text-center my-4">
                ...
                <p class="text-secondary">We are adding new titles to this category soon.</p>
