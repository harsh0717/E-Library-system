...
<head>
    ...
    <title>Add Category – BookVerse 3D Admin</title>
    ...
    <div class="glass-navbar-wrapper">
        <nav class="navbar navbar-expand-lg glass-navbar">
            <div class="container-fluid px-0">
                ...
                <button class="navbar-toggler border-0 text-white shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#navbarAddCat">
                    <i class="fas fa-bars fa-lg"></i>
                </button>

                <div class="collapse navbar-collapse" id="navbarAddCat">
                    <ul class="navbar-nav mx-auto nav-pills-glass gap-1 my-2 my-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="add-category.php"><i class="fas fa-folder-plus me-1"></i> Add Category</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
                <div>
                    <h1 class="font-display h3 text-white mb-1">
                        <i class="fas fa-folder-plus text-gradient-amber me-2"></i> Add Category
                    </h1>
                    <p class="text-secondary small mb-0">Create a new book genre or topic</p>
                </div>
            ...
            <form action="php/add-category.php" method="post">
                <div class="mb-4">
                    <label class="form-label-glass">
                        <i class="fas fa-tag text-warning me-1"></i> Category Name
                    </label>
                    <input type="text" class="form-control form-control-glass" name="category_name" placeholder="e.g. Science Fiction, Philosophy" required autofocus>
                </div>

                <button type="submit" class="btn-glass-3d btn-glass-amber w-100 py-3">
