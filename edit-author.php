...
<head>
    ...
    <title>Edit Author – BookVerse 3D Admin</title>
    ...
    <div class="glass-navbar-wrapper">
        <nav class="navbar navbar-expand-lg glass-navbar">
            <div class="container-fluid px-0">
                ...
                <button class="navbar-toggler border-0 text-white shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#navbarEditAuth">
                    <i class="fas fa-bars fa-lg"></i>
                </button>

                <div class="collapse navbar-collapse" id="navbarEditAuth">
        ...
        <div class="glass-card-form" style="max-width: 540px;">
            <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
                <div>
                    <h1 class="font-display h3 text-white mb-1">
                        <i class="fas fa-user-pen text-gradient-cyan me-2"></i> Edit Author
                    </h1>
                    <p class="text-secondary small mb-0">Update author's registered name</p>
                </div>
            ...
            <form action="php/edit-author.php" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control form-control-glass" name="author_name" value="<?= htmlspecialchars($author['name']) ?>" required autofocus>
                </div>
