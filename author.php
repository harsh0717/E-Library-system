...
<head>
    ...
    <title><?= htmlspecialchars($current_author['name']) ?> – BookVerse 3D</title>
...
<body>
    ...
    <div class="glass-navbar-wrapper">
        <nav class="navbar navbar-expand-lg glass-navbar">
            <div class="container-fluid px-0">
                ...
                <button class="navbar-toggler border-0 text-white shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#navbarAuthor">
    ...
    <header class="hero-section container">
        ...
        <div class="hero-badge">
            <i class="fas fa-feather-alt text-warning"></i> Author Showcase
        </div>
        <h1 class="hero-title">
            Works by <span class="text-gradient"><?= htmlspecialchars($current_author['name']) ?></span>
        </h1>
        <p class="hero-subtitle">
            Explore all published titles and digital editions by this distinguished author.
        </p>
    </header>
    ...
    <main class="books-container">
        <div class="section-header-row">
            <h2 class="section-title-3d">
                <i class="fas fa-book text-gradient"></i> Published Books
            </h2>
        ...
        <?php if (empty($books)): ?>
            <div class="glass-panel p-5 text-center my-4">
                ...
                <p class="text-secondary">No published titles found for this author yet.</p>
